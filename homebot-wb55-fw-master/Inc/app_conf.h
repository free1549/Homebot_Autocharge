 ...
 * Define Tx Power
 */   
#define CFG_TX_POWER                      (0x1F) /**< 1D:4dbm, -1:-1dbm, +1:+1dbm */

/**
 * Define Advertising parameters
 */
#define CFG_ADV_BD_ADDRESS                (0)
#define CFG_FAST_CONN_ADV_INTERVAL_MIN    (0x20)   /**< 20ms */
#define CFG_FAST_CONN_ADV_INTERVAL_MAX    (0x20)  /**< 20ms */
...
#define L2CAP_INTERVAL_MIN              CONN_P(20) /* 20ms */
#define L2CAP_INTERVAL_MAX              CONN_P(20) /* 20ms */
...
#define CFG_DEV_ID_P2P_SERVER                  (0x83)
...
/* USER CODE BEGIN CFG_Task_Id_With_NO_HCI_Cmd_t */
    CFG_TASK_PARSE_BLE_ID,
    CFG_TASK_TIMER_CHECK_ID,
    CFG_TASK_CONTROL_ROBOT_ID,
