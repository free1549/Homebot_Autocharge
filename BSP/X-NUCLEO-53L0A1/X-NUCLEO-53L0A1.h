...
#   define VL53L0A1_GPIO1_C_GPIO_PORT   GPIOB
#   define VL53L0A1_GPIO1_C_CLK_ENABLE  __GPIOB_CLK_ENABLE
#   define VL53L0A1_GPIO1_C_GPIO_PIN    GPIO_PIN_13
...
#       define VL53L0A1_GPIO1_C_INTx        EXTI15_10_IRQn
#       define VL53L0A1_EXTI4_15_USE_PIN    VL53L0A1_GPIO1_C_GPIO_PIN
#   endif // STM32L053xx
...
enum XNUCLEO53L0A1_dev_e{
    XNUCLEO53L0A1_DEV_CENTER  =  0, //!< center (built-in) vl053 device : 'c"
	XNUCLEO53L0A1_DEV_DLEFT =  1,	 //!< left satellite device P21 header : 'dl'
	XNUCLEO53L0A1_DEV_DRIGHT=  2,	 //!< Right satellite device P22 header : 'dr'
    XNUCLEO53L0A1_DEV_LEFT =  3,    //!< left satellite device P21 header : 'l'
    XNUCLEO53L0A1_DEV_RIGHT=  4     //!< Right satellite device P22 header : 'r'
