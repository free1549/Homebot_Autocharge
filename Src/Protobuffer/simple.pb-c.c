...
static const ProtobufCFieldDescriptor to_st__field_descriptors[20] =
{
  {
    "l_speed",
    1,
...
static const unsigned to_st__field_indices_by_name[] = {
  ...
  13,   /* field[13] = test_8 */
  14,   /* field[14] = test_9 */
  19,   /* field[19] = tohi_bypass */
  18,   /* field[18] = tohost_bypass */
};
static const ProtobufCIntRange to_st__number_ranges[5 + 1] =
{
  { 1, 0 },
  { 100, 4 },
  { 200, 5 },
...
static const unsigned to_hi__field_indices_by_name[] = {
  ...
  19,   /* field[19] = audio */
  10,   /* field[10] = battery */
  44,   /* field[44] = connect_server */
  16,   /* field[16] = do_charge */
  45,   /* field[45] = firmware_update_feedback */
  4,   /* field[4] = gyro_x */
  5,   /* field[5] = gyro_y */
  6,   /* field[6] = gyro_z */
  11,   /* field[11] = lenc */
  46,   /* field[46] = max_exposure */
  47,   /* field[47] = min_exposure */
  15,   /* field[15] = phone_public_key */
  8,   /* field[8] = pitch */
  38,   /* field[38] = play_pcm */
  13,   /* field[13] = power_button_pressed */
  22,   /* field[22] = pwm_led */
  39,   /* field[39] = qc_retry */
  12,   /* field[12] = renc */
  40,   /* field[40] = req_scan_ap */
  48,   /* field[48] = req_service_key */
  35,   /* field[35] = request_mic_loop_back */
  9,   /* field[9] = roll */
  20,   /* field[20] = set_ir_cut1 */
  21,   /* field[21] = set_ir_cut2 */
  36,   /* field[36] = set_mic_vol */
  18,   /* field[18] = set_mute */
  37,   /* field[37] = set_speaker_vol */
  41,   /* field[41] = ssid */
  42,   /* field[42] = ssid_password */
  43,   /* field[43] = ssid_type */
  23,   /* field[23] = test_1 */
  32,   /* field[32] = test_10 */
  24,   /* field[24] = test_2 */
  25,   /* field[25] = test_3 */
...
static const ProtobufCFieldDescriptor to_host__field_descriptors[30] =
{
  {
    "video",
    1,
...
static const unsigned to_host__field_indices_by_name[] = {
  25,   /* field[25] = ap_connection_result */
  29,   /* field[29] = ap_list */
  1,   /* field[1] = audio */
  15,   /* field[15] = auth_server_setup */
  22,   /* field[22] = bitrate */
  16,   /* field[16] = debugging_info */
  17,   /* field[17] = encrypted_secret_key */
  21,   /* field[21] = latency */
  24,   /* field[24] = play_pcm_end */
  18,   /* field[18] = pts */
  27,   /* field[27] = request_bandwidth */
  26,   /* field[26] = request_start_qc */
  14,   /* field[14] = room_server_setup */
  28,   /* field[28] = rsp_service_key */
  2,   /* field[2] = sensor_data */
  23,   /* field[23] = signal_level */
  13,   /* field[13] = signal_server_setup */
  3,   /* field[3] = test_1 */
  12,   /* field[12] = test_10 */
  4,   /* field[4] = test_2 */
  5,   /* field[5] = test_3 */
  ...
  11,   /* field[11] = test_9 */
  0,   /* field[0] = video */
  19,   /* field[19] = video_seq */
  20,   /* field[20] = video_ts */
};
